...
public class Fragment1 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(getArguments() != null){ //null : 빈값
            result = getArguments().getString("fromFrag2"); //프래그먼트 2로부터 setArguments된 데이터를 받아온다
        ...
        btn_move.setOnClickListener(new View.OnClickListener() { //프래그먼트2로 이동한다
            ...
            public void onClick(View view) {
                ...
                bundle.putString("fromFrag1","ping 프래그먼트 1");
                FragmentTransaction transaction = getActivity().getSupportFragmentManager().beginTransaction();
                Fragment2 fragment2 = new Fragment2();
                fragment2.setArguments(bundle);
                transaction.replace(R.id.frame_layout,fragment2);//첫번째 인자는 교체할 화면, 두번째 인자는 이동할 곳
